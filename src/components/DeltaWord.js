    ...
    return <div className="delta-word group absolute inline-block" style={{
        ...
        <div className="relative">
            <div className="text-3xl align-middle">
                <div
                    className="absolute left-0 top-0 h-full transition-all text-center bg-promask flex items-center justify-center"
                    style={{width: promaskPercentage}}>
                    <span className="opacity-0 group-hover:opacity-100 transition-all">{promaskPercentage}</span>
                </div>
                <div
                    className="absolute right-0 top-0 h-full transition-all text-center bg-nomask flex items-center justify-center"
