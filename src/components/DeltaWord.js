...
export default function DeltaWord({
  children,
  className,
  style,
  id,
  ...
  return (
    <div
      className="delta-word group absolute inline-block"
      style={{
    ...
    >
      <div className="relative">
        ...
        <span className="group-hover:opacity-0 transition-all relative px-1 cursor-default">
          {children}
        </span>
      </div>
    </div>
